...
const PHOTOS = [
  ...
  { src: 'https://picsum.photos/seed/couple5/500/500', caption: '우리가 된 날', rotate:  5, width: 220, photoHeight: 192, delay: 0.2 },
];
        ...
        <div style={{ position: 'relative', height: 360, display: 'flex', justifyContent: 'center' }}>
          {PHOTOS.map((p, i) => (
            <motion.div
              ...
              transition={{ duration: 0.7, delay: show(i + 1) ? p.delay : 0, type: 'spring', stiffness: 110, damping: 14 }}
